...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { mess_id: @voucher.mess_id, name: @voucher.name } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { mess_id: @voucher.mess_id, name: @voucher.name } }
