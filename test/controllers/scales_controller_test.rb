...
class ScalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scale" do
    assert_difference('Scale.count') do
      post scales_url, params: { scale: { item_id: @scale.item_id, qty: @scale.qty, scale_type: @scale.scale_type } }
    end
  ...
  test "should update scale" do
    patch scale_url(@scale), params: { scale: { item_id: @scale.item_id, qty: @scale.qty, scale_type: @scale.scale_type } }
